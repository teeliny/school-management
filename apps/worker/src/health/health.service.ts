 ...
 * bare-uptime stub. Mirrors apps/api/src/health/health.service.ts — same
 * four checks, since the worker talks to the same Postgres/Redis/Resend/
 * gateway dependencies the API does.
 */
@Injectable()
export class HealthService {
  ...
  async check(): Promise<HealthResponse> {
    ...
    return { status, service: "worker", checks };
  }
